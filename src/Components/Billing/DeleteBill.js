...
class DeleteBill extends React.Component {       
    ...
    handleSubmit = (event) => {
        ...
        axios.delete("http://localhost:8080/bill/delete/"+bill.billNo).then(this.setState({
            isDelete :true
        }));
        alert("Bill Deleted");     
        ...
        return(
            ...
            <div className="container-fluid"style={{overflowX:"auto"}}>
                ...
                <div class="form-group"style={{ textAlign: "left" }}>
                    ...
                    <input type="date" name="issueDate" value={this.state.issueDate} onChange={this.handleChange} class="form-control" disabled />
                </div>
                <div class="form-group"style={{ textAlign: "left" }}>
                    <label for="dueDate">Due Date</label>
                    <input type="date" name="dueDate" value={this.state.dueDate} onChange={this.handleChange} class="form-control" disabled/>
                </div>
                <div>
                <div class="form-group"style={{ textAlign: "left" }}>
